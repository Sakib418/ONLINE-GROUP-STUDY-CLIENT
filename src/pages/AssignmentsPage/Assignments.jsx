      ...
      {loading ? (
        ...
        <div className="grid lg:grid-cols-3 gap-6 mt-10">
          {assignments.length > 0 ? (
            assignments.map((assignment) => (
              <div key={assignment._id} className="card card-compact bg-base-100 shadow-xl">
                <figure>
                  <img
                    src={assignment.imageURL}
                    alt={assignment.Assignmenttitle || "Assignment"}
                ...
                <div className="card-body">
                  ...
                  <p className="text-sm text-gray-500">Marks: {assignment.AssignmentMarks}</p>
                  <p className="text-sm text-gray-500">
                    Date: {new Date(assignment.AssignmentDate).toLocaleDateString()}
                  </p>
            ...
            <p className="text-center text-lg font-semibold">No assignments found.</p>
          )}
        </div>
      )}
    </div>
